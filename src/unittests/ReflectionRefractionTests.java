...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		scene.geometries.add( //
				...
				new Sphere(new Point(0, 0, -50), 25d).setEmission(new Color(RED)) //
						.setMaterial(new Material().setKD(0.5).setKD(0.5).setnShininess(100)));
		scene.lights.add( //
	...
	public void twoSpheresOnMirrors() {
		...
		scene.geometries.add( //
				...
				new Traingle(new Point(1500, -1500, -1500), new Point(-1500, 1500, -1500), new Point(670, 670, 3000)) //
						.setEmission(new Color(20, 20, 20)) //
						.setMaterial(new Material().setKr(new Double3(1))),
				new Traingle(new Point(1500, -1500, -1500), new Point(-1500, 1500, -1500),
